...
class PersonDataAdmin(admin.ModelAdmin):
    readonly_fields = ('first_name', 'last_name', 'email', 'organisation', 'organisation_size', 'date', 'country', 'domain',
                       'phone_number', 'gender')
    ...
    def approve_selected_clients(self, request, queryset):
        queryset.update(is_approved=True)

    def deny_selected_clients(self, request, queryset):
