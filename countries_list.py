countries = [
     ...
     ("CD", "Congo"), ("CK", "Cook Islands"), ("CR", "Costa Rica"), ("CI", "Cote D'Ivoire"),
     ...
     ("UY", "Uruguay"),
     ("UZ", "Uzbekistan"), ("VU", "Vanuatu"), ("VE", "Venezuela"), ("VN", "Viet Nam"), ("VG", "Virgin Islands"),
     ("VI", "Virgin Islands"), ("WF", "Wallis and Futuna"), ("EH", "Western Sahara"), ("YE", "Yemen"), ("ZM", "Zambia"),
     ("ZW", "Zimbabwe"), ("AX", "Åland Islands"), ("BQ", "Bonaire"), ("CW", "Curaçao"), ("GG", "Guernsey"),
     ("IM", "Isle of Man"), ("JE", "Jersey"), ("ME", "Montenegro"), ("BL", "Saint Barthélemy"),
     ("MF", "Saint Martin (French part)"),
     ("RS", "Serbia"), ("SX", "Sint Maarten (Dutch part)"), ("SS", "South Sudan"), ("XK", "Kosovo")
]
